...
const OutletOrder = sequelize.define('OutletOrder', {
  id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
  orderNo: { type: DataTypes.STRING(32), allowNull: false },
  userId: { type: DataTypes.INTEGER, allowNull: false },
  serviceId: { type: DataTypes.INTEGER, allowNull: true },
  serviceTitle: { type: DataTypes.STRING(200), allowNull: false },
  serviceIcon: { type: DataTypes.STRING(100), defaultValue: 'setting-o' },
  ...
  timestamps: true,
  indexes: [{ unique: true, fields: ['orderNo'], name: 'outlet_orders_orderNo' }],
});
